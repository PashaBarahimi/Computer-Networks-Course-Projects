...
public:
    ...
    void SetCustomQueue(concurrent::Queue<std::pair<detail::KeyType,char>>* q) { kb.SetCustomQueue(q); }
    void PostToCustomQueue() { kb.PostToCustomQueue(); }
    void PostToScheduler() { kb.PostToScheduler(); }
